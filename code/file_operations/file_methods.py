...
class File_Operation:
    ...
    def __init__(self, file_object, logger_object, filename):
        ...
        self.model_directory=os.path.join('models/', filename)
    ...
    def save_model(self, model, modelname):
        ...
        try:
            path = os.path.join(self.model_directory,modelname)  # create separate directory for each cluster
            self.logger_object.log(self.file_object, 'Removing old model directory and creating fresh directory.')
            ...
            # do NOT write error to logs because the function calling this method will take care
            # of logging.
            raise ose
    ...
    #     try:
    #         with open(self.model_directory + modelname + '/' + modelname + '.sav',
    #                   'rb') as f:
    #             self.logger_object.log(self.file_object,
    #                                    'Model File ' + modelname + ' loaded. Exited the load_model method of the Model_Finder class')
    ...
    #                                    e))
    #         self.logger_object.log(self.file_object,
    #                                'Model File ' + modelname + ' could not be saved. Exited the load_model method of the Model_Finder class')
    #         raise Exception()
    #
